...
export default function Content() {
  return (
    <div >
      ...
      Once you complete the assignment, please send the pictures to the admin through the inbox. Your salary will be based on this.
      You will be given two tasks per week, which will include both assignments and tasks related to members.
      As soon as you complete a task, a new one will be assigned to you promptly.
      You will only need to make an investment once.
      We have various packages available that you can choose from.
